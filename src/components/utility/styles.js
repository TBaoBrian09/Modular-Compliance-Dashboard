...
export const Box = styled.div`
  ...
  align-items: ${props => (props.center ? "center" : props.alignItem ? props.alignItem : "")};
  ...
  overflow-x: ${props => (props.overflowX ? `${props.overflowX} !important` : "")};
  overflow-y: ${props => (props.overflowY ? `${props.overflowY} !important` : "")};
  flex-wrap: ${props => (props.flexWrap ? props.flexWrap : "")};
  @media (992px <= width < 1200px) {
    display: ${props => (props["flex-lg"] ? "flex" : "")};
    justify-content: ${props => (props["center-lg"] ? "center" : props["justify-lg"] ? props["justify-lg"] : "")};
  }
